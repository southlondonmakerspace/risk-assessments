...
* Switch off grinder.
* Do not use grinder while wheel is slowing down.
* Remove dust and swarf from grinder and workbench.
* Sweep floor.
...
* Inspect grinding wheel for cracks before use.

# Risk
## Hazard
Being pushed onto spinning grinding wheel
## Who
Operator
## Severity/Likelihood
Before 2-2 After 2-1
